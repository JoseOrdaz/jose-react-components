      ...
      <header aria-label="Site Header" className="shadow-2xl ">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex-1 max-w-xl md:flex md:items-center py-5">
              <Link className="block text-[#8c3cfc ]" href="/">
                {/* <Image
                  className="max-w-[120px] w-full p-5"
                  width={100}
                  height={100}
                  src="/logo-react.png"
                  alt="imagen"
            ...
            <div className="md:flex md:items-center">
              ...
              <div className="flex items-center gap-4">
                <div className="sm:flex sm:gap-4">
                  <Link target="_blank" href="https://github.com/JoseOrdaz">
                    <svg
                      viewBox="0 0 24 24"
                      aria-hidden="true"
                      class="h-8 w-8 fill-slate-900"
                    >
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
